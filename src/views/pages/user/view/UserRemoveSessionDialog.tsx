        ...
        <DialogContent>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
            <Box sx={{ maxWidth: '85%', textAlign: 'center', '& svg': { mb: 1, color: 'warning.main' } }}>
              ...
              <Typography>Are you sure you would like to remove your all other sessions?</Typography>
            </Box>
          </Box>
        </DialogContent>
      ...
      >
        <DialogContent>
          ...
          >
            ...
            <Typography>
              {userInput === 'yes' ? 'Your sessions removed successfully.' : 'Operation Cancelled!!'}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions sx={{ justifyContent: 'center' }}>
